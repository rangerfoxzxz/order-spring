pipeline {
    ...
    stages {
        ...
        stage('Build Maven') {
            steps {
                checkout([$class: 'GitSCM', credentialsId: 'githubpwd', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/rangerfoxzxz/order-spring.git']]])
        ...
        stage('Deploy to k8s') {
            steps {
                withKubeConfig([credentialsId: 'kubectlpwd', serverUrl: 'https://127.0.0.1:52660']) {
                    script {
